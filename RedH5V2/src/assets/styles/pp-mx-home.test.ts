...
describe('PP.BET home CSS contract', () => {
  ...
  it('keeps game tile provider labels gray in the PP.BET light theme', () => {
    const normalized = normalizeCss(css)
  ...
  it('themes Vant dialogs with the PP.BET dark red-gold visual system', () => {
  ...
  it('themes Vant toasts as compact PP.BET premium notifications', () => {
  ...
  it('adds the PP.BET light theme contract without changing the dark default', () => {
  ...
  it('keeps auth error text readable in the PP.BET light theme', () => {
    const normalized = normalizeCss(css)
  ...
  it('uses the PP.BET reference Montserrat font stack for visible non-icon text', () => {
  ...
  it('keeps SVG wordmarks on the PP.BET Montserrat stack without legacy font fallbacks', () => {
  ...
  it('maps PP.BET light utility colors to the v6 readable grayscale and red accent scale', () => {
    const normalized = normalizeCss(css)
  ...
  it('keeps PP.BET light overlays and remaining subpages readable', () => {
    const normalized = normalizeCss(css)
  ...
  it('keeps offline and shared overlay text on PP.BET reference colors', () => {
