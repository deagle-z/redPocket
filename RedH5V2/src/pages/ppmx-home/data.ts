...
export const ppmxNotices: PpmxNotice[] = [
  {
    ...
    target: 'registro',
    text: {
      es: 'Regístrate y recibe $58 MXN gratis',
      en: 'Sign up and get $58 MXN free',
      zh: '注册立即赠送 58 比索',
    },
  },
  {
...
export const ppmxBanners: PpmxBanner[] = [
  {
    ...
    thumbs: [11, 13, 14],
    amountHtml: {
      es: '<span class="cur">$</span>58<span class="suf">MXN</span>',
      en: '<span class="cur">$</span>58<span class="suf">MXN</span>',
      zh: '<span class="cur">$</span>58<span class="suf">比索</span>',
    },
  ...
  },
  {
    ...
    sub: {
      ...
      en: 'Play anywhere: download the PP.MX app, log in and get $30 MXN instantly.',
