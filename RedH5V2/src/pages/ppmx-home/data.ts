...
export const ppmxNotices: PpmxNotice[] = [
  {
    ...
    target: 'registro',
    text: {
      es: 'Regístrate y recibe S/58 PEN gratis',
      en: 'Sign up and get S/58 PEN free',
      zh: '注册立即赠送 58 比索',
    },
  },
  {
...
export const ppmxBanners: PpmxBanner[] = [
  {
    ...
    thumbs: [11, 13, 14],
    amountHtml: {
      es: '<span class="cur">S/</span>58<span class="suf">PEN</span>',
      en: '<span class="cur">S/</span>58<span class="suf">PEN</span>',
      zh: '<span class="cur">S/</span>58<span class="suf">索尔</span>',
    },
