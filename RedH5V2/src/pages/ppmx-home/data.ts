...
export const ppmxNotices: PpmxNotice[] = [
  {
    ...
    target: 'registro',
    text: {
      es: 'Regístrate y recibe S/3 PEN gratis',
      en: 'Sign up and get S/3 PEN free',
      zh: '注册立即赠送 3 比索',
    },
  },
  {
  ...
  },
  {
    ...
    text: {
      es: 'Juego 100% seguro y regulado · +18',
      en: '100% safe & regulated gaming · 18+',
      zh: '100% 安全合规博彩 · 18 岁以上',
    },
  },
]
...
export const ppmxBanners: PpmxBanner[] = [
  {
    ...
    thumbs: [11, 13, 14],
    amountHtml: {
      es: '<span class="cur">S/</span>3<span class="suf">PEN</span>',
      en: '<span class="cur">S/</span>3<span class="suf">PEN</span>',
      zh: '<span class="cur">S/</span>3<span class="suf">比索</span>',
    },
    ...
    terms: { es: '1 por persona/dispositivo. Rollover 10x. Aplican T&C. +18.', en: '1 per person/device. 10x rollover. T&C apply. 18+.', zh: '每人/每设备限领一次，10 倍流水，适用条款，18 岁以上。' },
  },
  {
    id: 'checkin',
    ...
    thumbs: [21, 26, 28],
    amountHtml: text('<span class="cur">S/</span>1'),
    tag: { es: 'Check-in de bienvenida', en: 'Welcome check-in', zh: '新人签到' },
    benefitHtml: {
      es: 'Entra cada día y recibe S/1 <span class="pill">Cofre día 7</span>',
      en: 'Log in daily and get S/1 <span class="pill">Day-7 chest</span>',
      zh: '每日签到送 1 比索 <span class="pill">第 7 天宝箱</span>',
    },
    ...
    terms: { es: 'Solo nuevos usuarios. 1 check-in por día. Rollover 10x. +18.', en: 'New users only. 1 check-in per day. 10x rollover. 18+.', zh: '仅限新用户，每日限签到一次，10 倍流水，18 岁以上。' },
  },
  {
    id: 'vip',
    ...
    terms: { es: 'Bono según nivel alcanzado. Rollover 10x. +18.', en: 'Bonus by level reached. 10x rollover. 18+.', zh: '红利依达成等级而定，10 倍流水，18 岁以上。' },
  },
  {
    id: 'invita',
    ...
    terms: { es: 'Comisión según el número de recarga del referido. +18.', en: 'Commission based on referral deposit count. 18+.', zh: '按下级充值次数计算返佣，18 岁以上。' },
  },
  {
    id: 'recarga',
    ...
    terms: { es: 'Bono según número de recarga. Rollover 10x. +18.', en: 'Bonus by deposit count. 10x rollover. 18+.', zh: '按充值次数赠送，10 倍流水，18 岁以上。' },
  },
  {
    id: 'download',
    ...
    sub: {
      ...
      en: 'Play anywhere: download the PP.PE app, log in and get S/30 PEN instantly.',
    ...
    terms: { es: '1 por cuenta/dispositivo. Rollover 10x. +18.', en: '1 per account/device. 10x rollover. 18+.', zh: '每账户/设备限领一次，10 倍流水，18 岁以上。' },
  },
  {
    id: 'wheel',
    ...
    terms: { es: '1 giro gratis/día. Rollover según premio. +18.', en: '1 free spin/day. Rollover varies by prize. 18+.', zh: '参与游戏免费获得旋转次数，10 倍流水，18 岁以上。' },
  },
]
