...
const supportText = {
  ...
  safe: {
    es: 'Usa solo canales oficiales PP.BET. Nunca compartas tu contraseña.',
    en: 'Use PP.BET official channels only. Never share your password.',
    zh: '请仅使用 PP.BET 官方渠道，切勿泄露密码。',
  },
