...
> **This file covers the Go backend only.** Frontend sub-projects each have their own AGENTS.md:
> - [pure-admin-thin/AGENTS.md](pure-admin-thin/AGENTS.md) — Superadmin dashboard (Element Plus)
> - [RedTenantAdmin/AGENTS.md](RedTenantAdmin/AGENTS.md) — Tenant management panel (Element Plus)
> - [RedPocketH5/AGENTS.md](RedPocketH5/AGENTS.md) — Mobile H5 app (Vant)
