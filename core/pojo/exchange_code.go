...
type ExchangeCodeRedeem struct {
	...
	UserID          int64   `json:"userId" gorm:"column:user_id;type:bigint;not null;uniqueIndex:idx_exchange_code_redeem_once,priority:2;index;index:idx_exchange_code_redeem_batch_user,priority:2;comment:用户ID"`
