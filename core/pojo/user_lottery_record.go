...
type UserLotteryRecord struct {
	...
	BeforeBalance float64   `json:"beforeBalance" gorm:"type:decimal(18,2);not null;default:0"` // 抽奖前用户余额
	AfterBalance  float64   `json:"afterBalance" gorm:"type:decimal(18,2);not null;default:0"`  // 抽奖后用户余额
