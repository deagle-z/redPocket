...
export function useSysVipLevel(tableRef: Ref) {
  ...
  const columns: TableColumnList = [
    ...
    { label: "总提现次数", prop: "totalWithdrawCount", minWidth: 100, formatter: ({ totalWithdrawCount }) => totalWithdrawCount ?? "-" },
    ...
    addDialog({
      ...
      props: {
        formInline: {
          ...
          totalWithdrawCount: row?.totalWithdrawCount ?? null,
          ...
          if (valid) {
            try {
              await setSysVipLevel({
                ...
                totalWithdrawCount: curData.totalWithdrawCount,
