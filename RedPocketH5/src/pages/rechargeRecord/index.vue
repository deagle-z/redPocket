...
import OrderRecordList from '@/components/OrderRecordList.vue'
import { getRechargeOrderHistory } from '@/api/user'
...
<template>
  <div class="order-record-page">
    <AppPageHeader :title="t('orderRecordPage.rechargeTitle')" @back="goBack" />
    <OrderRecordList kind="recharge" :loader="getRechargeOrderHistory" />
  </div>
</template>
