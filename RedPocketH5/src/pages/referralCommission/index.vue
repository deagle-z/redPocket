...
const referralCommissionImageMap: Record<string, string> = {
...
<template>
  <main class="activity-image-page">
    <AppPageHeader :title="t('activityPage.referralCommission')" @back="goBack" />

    <button type="button" class="activity-image-entry" @click="goInvite">
      <img
        class="activity-image"
        :src="referralCommissionImage"
        :alt="t('activityPage.referralCommission')"
      >
    </button>
  </main>
</template>
