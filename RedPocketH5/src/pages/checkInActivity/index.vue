...
import checkInActivityImage from '@/assets/images/long_image_mexico/7_days_challenge_short_mexico.png'
...
<template>
  <main class="activity-image-page">
    <AppPageHeader :title="t('activityPage.checkIn')" @back="goBack" />

    <button type="button" class="activity-image-entry" @click="goCheckIn">
      <img
        class="activity-image"
        :src="checkInActivityImage"
        :alt="t('activityPage.checkIn')"
      >
    </button>
  </main>
</template>
