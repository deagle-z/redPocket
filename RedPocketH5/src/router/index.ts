...
const publicRouteNames = new Set(['Home', 'Login', 'Register', 'ForgotPassword', 'luckyDetail', 'Demo'])
const publicRoutePaths = new Set(['/', '/login', '/register', '/resetpwd', '/resetpwd/', '/luckyDetail', '/cs', '/cs/', '/demo', '/demo/'])
